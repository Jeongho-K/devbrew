...
docreview:
  ...
  findings:
    ...
    fee27fc9#r2.2:
      ...
      lineage: fee27fc9#r1.1
      bucket: fee27fc9
      supersedes: fee27fc9#r1.1
      origin: auto
      layer: 1
      category: scope
      anchor: '#3-non-goals'
      disposition: decide
      summary: '채택 후 미적용(expired): Non-goals 가 브리프의 범위 항목 하나를 조용히 뺐다'
      edit_scope: '#3-non-goals'
      blocks: []
      evidence: 라운드 2 에 채택 변경 관측 없음 (D1.1)
      decision_view:
...
- r1: decide fee27fc9#r1.1 adopt
- r2: begin-round (rereview_count=1)
- r2: observe-diff applied=0 expired=1
